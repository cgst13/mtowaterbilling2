...
import {
  Box, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, MenuItem, Select, InputLabel, FormControl, TextField, Snackbar, Alert, TablePagination, Stack, Autocomplete, Tabs, Tab
} from '@mui/material';
import { Add as AddIcon, Edit as EditIcon, Delete as DeleteIcon, Receipt as ReceiptIcon, Person as PersonIcon, CalendarMonth as CalendarMonthIcon, Paid as PaidIcon } from '@mui/icons-material';
...
const Billing = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Paper elevation={3} sx={{ maxWidth: 1300, mx: 'auto', p: 2 }}>
        ...
        {tab === 0 && (
          <>
            <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 2, flexWrap: 'wrap' }}>
              <Typography variant="h6" sx={{ fontWeight: 600, flexGrow: 1 }}>Search Customers to Add Bill</Typography>
              <TextField
      ...
      {/* Add/Edit Bill Dialog and Snackbar remain unchanged */}
